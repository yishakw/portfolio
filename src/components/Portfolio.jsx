...
function Project({ photo }) {
  return (
    <div className="border-2 h-[300px] bg-gray-500 drop-shadow-2xl rounded-2xl transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-105 hover:bg-gray-200 duration-800 m-5">
      {/* w-[500px]  */}
